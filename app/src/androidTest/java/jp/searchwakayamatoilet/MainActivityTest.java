...
public class MainActivityTest {
    ...
    public void isMethodSetMarkersByFreeWordCalled() throws Exception {
        ...
        onView(ViewMatchers.withId(R.id.searchview)).perform(ViewActions.click());
        onView(ViewMatchers.isAssignableFrom(EditText.class)).perform(ViewActions.typeText("test"), ViewActions.pressKey(KeyEvent.KEYCODE_ENTER));
        verify(presenter).setMarkersByFreeWord("");
